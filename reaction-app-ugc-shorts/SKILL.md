---
name: reaction-app-ugc-shorts
description: "Create or direct short vertical UGC reaction videos for consumer apps in the style of lightweight social memes: a single believable character, one fixed on-screen premise caption, a simple visual reaction, and product mention embedded naturally in the joke. Use for TikTok, Reels, Shorts, AI-video prompts, shot lists, scripts, and QA of 7–15 second app-marketing videos."
---

# Reaction-App UGC Shorts
...
- Use one familiar, slightly cinematic setting with depth: kitchen, couch, desk, café, elevator, or street. Keep it uncluttered.
...
Read [references/style-system.md](references/style-system.md) for the observed reference pattern, caption templates, and prompt recipe.
